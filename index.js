...
var questionHelper = require('./questionHelper');
var APP_ID = "amzn1.ask.skill.f1b3bd3b-fc30-449c-aaf6-b6ddb1ca4898";  // TODO replace with your app ID (OPTIONAL).
...
var url = 'https://mysterious-mountain-45455.herokuapp.com/questions';
var languageString;
var questions;
  ...
  languageString = {
    "en-GB": {
      "translation": {
        ...
        "GAME_NAME" : "British Developer Trivia", // Be sure to change this for your skill.
    ...
    "en-US": {
      "translation": {
        ...
        "GAME_NAME" : "American Developer Trivia", // Be sure to change this for your skill.
        "HELP_MESSAGE": "I will ask you %s multiple choice questions. Respond with the number of the answer. " +
          "For example, say one, two, three, or four. To start a new game at any time, say, start game. ",
        "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat. ",
        "ASK_MESSAGE_START": "Would you like to start playing?",
...
exports.handler = function(event, context, callback) {
  ...
  questionData.requestQuestions().then(function(){
    console.log("In the callback", questions);
